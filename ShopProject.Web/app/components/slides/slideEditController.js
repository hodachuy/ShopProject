(function (app) {
    ...
    slideEditController.$inject = ['$scope', 'apiHttpService', 'notificationService', '$state', '$stateParams', 'commonService'];
    function slideEditController($scope, apiHttpService, notificationService, $state, $stateParams, commonService) {
        $scope.slide = [];
        ...
        function GetSlidebyID() {
            apiHttpService.get('api/slide/getbyid/' + $stateParams.slideID, null, function (result) {
                $scope.slide = result.data;
                if ($scope.slide.Image === null || $scope.slide.Image == "") {
                    $(".pip").hide();
                }
            }, function (error) {
        ...
        function EditSlide() {
            apiHttpService.put('api/slide/edit', $scope.slide, function (result) {
